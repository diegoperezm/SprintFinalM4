...
public class Administrativo extends Usuario {
	...
	public Administrativo(String nombre, LocalDate fechaNacimiento, int run, String area, String experienciaPrevia) {
		...
		if (area.length() < 5 || area.length() > 20)
			throw new InputMismatchException("Entrada no valida, área: mínimo 5 caracteres, máximo 20 caracteres");
		this.area = area;

		if (experienciaPrevia.length() > 100)
			throw new InputMismatchException("Entrada no valida, experiencia previa:  máximo 100 caracteres");
